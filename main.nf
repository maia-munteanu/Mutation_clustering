...
process get_vcfs {
       publishDir params.output_folder+"/VCFs/Closer_/"+params.closer_value+"/", mode: 'copy', pattern: '*closer.snv.vcf'
       publishDir params.output_folder+"/VCFs/Close_/"+params.close_value+"/", mode: 'copy', pattern: '*close.snv.vcf'
